...
# --- Навчання vs Індекс вартості проживання --- #
plt.figure(figsize=(10, 6))
plt.scatter(
    data['Tuition_USD'],
    data['Living_Cost_Index'],
    alpha=0.6,
    color='coral'
)
plt.title('Навчання vs Індекс вартості проживання', fontsize=14)
plt.xlabel('Вартість навчання (USD)', fontsize=12)
plt.ylabel('Індекс вартості проживання', fontsize=12)
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Навчання vs Оренда житла', fontsize=14)
plt.xlabel('Вартість навчання (USD)', fontsize=12)
plt.ylabel('Орендна плата (USD/місяць)', fontsize=12)
plt.grid(True)
plt.tight_layout()
plt.show()
